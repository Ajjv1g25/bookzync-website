...
export function AtelierChatLauncher() {
      ...
      {!isOpen && (
        ...
        >
          ...
          <button
            ...
            aria-label="Chat with Atelier N°9"
            ...
            style={{
              ...
              boxShadow:
                "0 1px 0 0 rgba(255,255,255,0.3) inset, 0 12px 32px -4px rgba(245,158,11,0.55), 0 4px 12px -2px rgba(26,20,16,0.3)",
            }}
          >
            <span
              aria-hidden
